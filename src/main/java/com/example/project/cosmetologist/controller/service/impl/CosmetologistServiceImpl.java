package com.example.project.cosmetologist.controller.service.impl;
...
import com.example.project.cosmetologist.controller.mappers.impl.CosmetologistMapperImpl;
...
import com.example.project.customer.controller.mappers.CustomerAssembler;
...
import com.example.project.exceptions.CustomBadRequestException;
...
import com.example.project.procedure.model.ProcedureRepository;
...
//        return convertToDto(cosmetologist);
    ...
    public List<CustomerDTO> getCustomersForCosmetologist(Long cosmetologistId) {
        List<Customer> customers=cosmetologistRepository.getCustomersForCosmetologist(cosmetologistId);
